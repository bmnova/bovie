  ...
  return (
    <main className="min-h-screen bg-surface">
      ...
      <section
        ...
        style={{
          background:
            "radial-gradient(ellipse 80% 60% at 50% -10%, #B6007618, transparent)",
        }}
      >
        <div className="mx-auto max-w-4xl text-center">
          <span className="mb-5 inline-block rounded-full border border-[#B60076]/20 bg-[#B60076]/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-widest text-[#B60076]">
            Mobile · Flutter · AI · Manga
          </span>
        ...
        <div
          ...
          style={{
            background: "radial-gradient(circle, #B6007610, transparent 70%)",
          }}
        />
      </section>
      ...
      <section className="px-6 py-20 md:px-12">
        <div className="mx-auto max-w-5xl">
          <p className="mb-3 text-xs font-semibold uppercase tracking-widest text-[#B60076]">
            {kami.eyebrow}
          </p>
      ...
      <section className="px-6 pb-28 pt-4 text-center md:px-12">
        <div className="mx-auto max-w-xl">
          ...
          <p className="mb-8 text-muted">{kami.ctaSub}</p>
          <Link
            href="/#contact"
            className="inline-flex rounded-full bg-[#B60076] px-8 py-3.5 text-sm font-semibold text-white shadow-lg shadow-[#B60076]/25 transition-all hover:opacity-90"
          >
            {kami.ctaButton}
          </Link>
        </div>
