...
import { accountDataDeletionContent } from "@/content/account-data-deletion";
...
export function AccountDataDeletionContent() {
  const { locale } = useLocale();
  const content = accountDataDeletionContent[locale];
  const { accountDataDeletion } = contentMap[locale];
      ...
      <section className="px-6 pb-20 pt-4 md:px-12">
        <div className="mx-auto max-w-3xl">
          ...
          >
            ...
            >
              {accountDataDeletion.lastUpdatedLabel} {content.lastUpdated}
            </motion.p>
            <motion.h1
              variants={fadeInUp}
            ...
            {content.intro?.length > 0 && (
              <motion.div
                variants={fadeInUp}
                className="mb-10 space-y-3 text-sm leading-relaxed text-muted"
              >
