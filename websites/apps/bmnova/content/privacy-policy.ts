  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        title: "Legal Bases",
        paragraphs: [
          "Where applicable under GDPR or similar laws, we rely on one or more of the following legal bases: performance of a contract; legitimate interests; consent; legal obligation; establishment, exercise, or defense of legal claims.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "We may share personal data with: cloud, hosting, analytics, communication, authentication, payment, support, and infrastructure providers; AI service providers used to deliver requested product functionality; clients and partners where needed for project delivery; legal, accounting, insurance, and professional advisers; public authorities or regulators where required by law; parties involved in a merger, acquisition, restructuring, or similar transaction; other parties where you direct us to share data or clearly consent.",
        ],
      },
      {
        number: 12,
      ...
      },
      {
        ...
        title: "Your Rights",
        paragraphs: [
          "Depending on applicable law, you may have the right to: learn whether your personal data is processed; request access to your data; request correction of inaccurate or incomplete data; request deletion of data, where applicable; object to certain processing; request restriction of processing; withdraw consent where processing is based on consent; request portability where applicable; request information about recipients of transferred data; submit a complaint to a competent authority.",
  ...
  tr: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "GDPR veya benzeri düzenlemelerin uygulandığı durumlarda aşağıdaki hukuki sebeplerden birine veya birkaçına dayanabiliriz: sözleşmenin kurulması veya ifası; meşru menfaat; açık rıza; hukuki yükümlülük; bir hakkın tesisi, kullanılması veya korunması.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Kişisel verileri şu taraflarla paylaşabiliriz: bulut, barındırma, analiz, iletişim, kimlik doğrulama, ödeme, destek ve altyapı sağlayıcıları; talep edilen ürün işlevini sunmak için kullanılan yapay zekâ hizmet sağlayıcıları; proje teslimi için gerekli müşteriler ve iş ortakları; hukuk, muhasebe, sigorta ve diğer profesyonel danışmanlar; mevzuat gereği yetkili kurum ve kuruluşlar; birleşme, devralma, yeniden yapılanma veya benzeri işlemlerde ilgili taraflar; sizin yönlendirmeniz veya açık onayınız bulunan diğer taraflar.",
        ],
      },
      {
        number: 12,
      ...
      },
      {
        ...
        title: "Haklarınız",
        paragraphs: [
          "Uygulanabilir mevzuata bağlı olarak şu haklara sahip olabilirsiniz: kişisel verilerinizin işlenip işlenmediğini öğrenme; kişisel verilerinize erişim talep etme; eksik veya yanlış verilerin düzeltilmesini isteme; uygun hallerde verilerin silinmesini isteme; belirli işleme faaliyetlerine itiraz etme; işlemenin sınırlandırılmasını isteme; açık rızaya dayalı işlemlerde rızayı geri çekme; uygulanabiliyorsa veri taşınabilirliği talep etme; verilerin aktarıldığı alıcılar hakkında bilgi talep etme; yetkili mercilere şikâyette bulunma.",
