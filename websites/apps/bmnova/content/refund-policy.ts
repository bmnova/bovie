    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Where Paddle or another merchant-of-record/payment partner handles checkout: that provider may process payments, taxes, invoices, renewals, and certain refund requests under its own terms and policies; refund handling may therefore be managed partly or fully through that provider's systems; you may be asked to submit your refund request through the billing provider's support channel or buyer portal.",
          "If your purchase was made through a BMNova website checkout flow powered by Paddle, your order may be processed by Paddle as merchant of record. Paddle recommends that sellers clearly disclose this on their websites and also recommends that refund policies be published clearly before purchase.",
        ],
      },
      {
        number: 4,
        ...
        paragraphs: [
          ...
          "Apple states that App Store purchases may be eligible for refund and directs users to request refunds through Apple's own refund flow, while subscription cancellations are managed through Apple account settings.",
          "If your purchase was made through Apple: you should use Apple's refund request process; subscription cancellation should generally be managed in your Apple account settings; BMNova cannot directly issue or force refunds for transactions controlled by Apple's billing system.",
        ],
      },
      {
        number: 5,
        ...
        paragraphs: [
          ...
          "Google states that refund availability depends on what was purchased, when and how payment was made, and the user's location. Google also notes that many apps are provided by third-party developers and that contacting the app developer may sometimes be the quickest way to resolve an issue.",
          "If your purchase was made through Google Play: you should first review Google Play's refund request options; cancellation of subscriptions is generally managed through your Google Play account; in some situations, BMNova may review the issue and assist where the platform allows.",
        ],
      },
      {
        number: 6,
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "We may first try to: verify the issue; provide support or troubleshooting steps; restore access or correct the billing problem; offer a refund where appropriate and where we are able to do so.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Paddle notes that disputes and chargebacks may be handled through its systems when Paddle is merchant of record, and recommends that sellers resolve buyer payment issues early where possible.",
        ],
      },
      {
        number: 10,
        ...
        paragraphs: [
          ...
          "Please include, where available: the product or app name; the purchase email address; the order number or transaction ID; the platform used for purchase, such as web, Apple App Store, or Google Play; a short explanation of the issue.",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Paddle veya başka bir merchant-of-record / ödeme ortağı ödeme sürecini yürütüyorsa: ödemeler, vergiler, faturalar, yenilemeler ve bazı iade talepleri ilgili sağlayıcının kendi koşulları ve politikaları kapsamında işlenebilir; bu nedenle iade süreçleri kısmen veya tamamen ilgili sağlayıcının sistemleri üzerinden yürütülebilir; iade talebinizi, ödeme sağlayıcısının destek kanalı veya alıcı paneli üzerinden iletmeniz istenebilir.",
          "Satın alma işleminiz Paddle destekli bir BMNova web ödeme akışı üzerinden yapıldıysa, siparişiniz Paddle tarafından merchant of record olarak işlenebilir. Paddle, satıcıların bunu web sitelerinde açıkça belirtmesini ve iade politikasını satın alma öncesinde görünür şekilde yayımlamasını önermektedir.",
        ],
      },
      {
        number: 4,
        ...
        paragraphs: [
          ...
          "Satın alma işleminiz Apple üzerinden yapıldıysa: iade talebinizi Apple'ın ilgili süreci üzerinden iletmelisiniz; abonelik iptalini genel olarak Apple hesap ayarlarınızdan yapmalısınız; Apple'ın faturalama sistemi üzerinden yürütülen işlemler için BMNova doğrudan iade yapamaz veya iade sürecini zorunlu kılamaz.",
        ],
      },
      {
        number: 5,
        ...
        paragraphs: [
          ...
          "Google, iade uygunluğunun satın alınan ürünün türüne, ödemenin ne zaman ve nasıl yapıldığına ve kullanıcının bulunduğu yere göre değişebileceğini belirtmektedir. Google ayrıca, birçok uygulamanın üçüncü taraf geliştiriciler tarafından sunulduğunu ve bazı durumlarda geliştiriciyle iletişime geçmenin en hızlı çözüm yolu olabileceğini ifade etmektedir.",
          "Satın alma işleminiz Google Play üzerinden yapıldıysa: önce Google Play'in iade talep seçeneklerini incelemelisiniz; abonelik iptalini genel olarak Google Play hesabınız üzerinden yapmalısınız; bazı durumlarda BMNova, platformun izin verdiği ölçüde durumu inceleyip yardımcı olabilir.",
        ],
      },
      {
        number: 6,
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Öncelikle şu adımları deneyebiliriz: sorunu doğrulamak; destek veya sorun giderme adımları sunmak; erişimi geri sağlamak veya faturalama sorununu düzeltmek; uygun olduğunda ve yapabildiğimiz ölçüde iade sunmak.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Paddle, merchant of record olduğu işlemlerde uyuşmazlık ve chargeback süreçlerinin kendi sistemleri üzerinden yürütülebileceğini ve satıcıların mümkünse ödeme sorunlarını erken aşamada çözmesini önerdiğini belirtmektedir.",
        ],
      },
      {
        number: 10,
        ...
        paragraphs: [
          ...
          "Mümkünse aşağıdaki bilgileri paylaşın: ürün veya uygulama adı; satın alma sırasında kullanılan e-posta adresi; sipariş numarası veya işlem kimliği; satın alma platformu: web, Apple App Store veya Google Play; sorunun kısa açıklaması.",
